...
def assign_port(datapath, callvariant, EUvariant, filename):
...
def assign_trip(datapath, callvariant, EUvariant, filename):
    #%% ############## Assign trip numbers ##############
...
def subset_EU_trips(part, EU_trips):
...
def subset_EU(datapath, callvariant, EUvariant, filename):
    #%% ###### Subset EU trips ######
...
def calc_FC(datapath, callvariant, EUvariant, filename):
    ...
    selected_columns = [
        'IMO.Number', 'ME_W_ref', 'W_component', 
...
def calc_sum_stats(datapath, callvariant, EUvariant, filename):
