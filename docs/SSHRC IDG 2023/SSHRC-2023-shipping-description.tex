...
Using the estimated fuel efficiency for each ship and its travel history, it is straightforward to compute the worldwide CO$_2$ emissions within each month of the years from 2018 to 2022 by aggregating fuel consumptions across all ships. Fuel consumption for each origin--destination port pair
