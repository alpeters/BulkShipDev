...
filenames_df <- tribble(
  ~target, ~transform,   ~models,        ~set, ~split_feature1,                ~splits1, ~split_feature2,         ~splits2,     ~csv_file,   ~csv_file_within,     ~train_split,
     ...
     # 'fc',           "",       "", 'djdrank10',   'relseaspeed',    paste0("quart", 1:4),              NA,               NA,     'test_fc',     'train_target',           "",
      'fc',           "",       "", 'djdrank10',   'relseaspeed',              "quart1",              NA,               NA,     'test_fc',            'best_train_fc',        "quart1",
      'fc',           "",       "", 'djdrank10',   'relseaspeed',              "quart2",              NA,               NA,     'test_fc',            'best_train_fc',        "quart2",
      'fc',           "",       "", 'djdrank10',   'relseaspeed',              "quart3",              NA,               NA,     'test_fc',            'best_train_fc',        "quart3",
      'fc',           "",       "", 'djdrank10',   'relseaspeed',              "quart4",              NA,               NA,     'test_fc',            'best_train_fc',        "quart4",
     ...
     # 'fc',           '',       "",   "djdrank10", "relseaspeed",                    "dec1",            NA,               NA,   'test_target',   'train_target',           "high",
     # 'fc',           '',       "",   "djdrank10", "relseaspeed",                   "dec10",            NA,               NA,   'test_target',   'train_target',           "low",
     # 'fc',           '',       "",        "oecd", "relseaspeed",                    "dec1",            NA,               NA,   'test_target',   'train_target',           "high",
     # 'fc',           '',       "",        "oecd", "relseaspeed",                   "dec10",            NA,               NA,   'test_target',   'train_target',            "low",
     # 'fc',           '',       "",        "work", "relseaspeed",                    "dec1",            NA,               NA,   'test_target',   'train_target',           "high",
     # 'fc',           '',       "",        "work", "relseaspeed",                   "dec10",            NA,               NA,   'test_target',   'train_target',            "low",
     # 'fe',     'linear',       "",   "djdrank10", "relseaspeed",                    "dec1",            NA,               NA,       'test_fc',       'train_fc',           "high",
     # 'fe',     'linear',       "",   "djdrank10", "relseaspeed",                   "dec10",            NA,               NA,       'test_fc',       'train_fc',            "low",
     # 'fe',     'linear',       "",        "oecd", "relseaspeed",                    "dec1",            NA,               NA,       'test_fc',       'train_fc',           "high",
     # 'fe',     'linear',       "",        "oecd", "relseaspeed",                   "dec10",            NA,               NA,       'test_fc',       'train_fc',            "low"
)
...
```{r}
# This was for comparing FC to FE
