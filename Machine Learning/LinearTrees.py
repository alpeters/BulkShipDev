# Two layer Two residual model, Linear + trees, both with model-selected features
...
median_imputer_2 = SimpleImputer(strategy='median')

standard_scaler_2 = StandardScaler()

log_transformer_2 = FunctionTransformer(np.log1p, validate=True)
ordinal_transformer_2 = make_pipeline(OrdinalEncoder(categories=[['Capesize', 'Panamax', 'Handymax', 'Handysize']]))


impute_and_transform_2 = Pipeline(steps=[('imputer', median_imputer_2),
                                         ('log_transform', log_transformer_2)])

impute_scale_transform_2 = make_pipeline(median_imputer_2, log_transformer_2, standard_scaler_2)

preprocessor_trees_2 = ColumnTransformer(
    transformers=[
        ('impute_and_transform', impute_and_transform_2, log_transform_cols),
        ('ordinal', ordinal_transformer_2, ordinal_cols)])

preprocessor_linear_2 = ColumnTransformer(
    transformers=[
        ('impute_scale_transform', impute_and_transform_2, log_transform_cols),
        ('ordinal', ordinal_transformer_2, ordinal_cols)])
