...
```{r}
split_feature <- c('relseaspeed', 'draught') #'dwt' #
...
metric_table <- metric_table |> 
  mutate(set = factor(set,
         ...
         quartile = factor(quartile,
                           levels = c('1low', '1high', '4low', '4high'),
                           labels = c('slow,empty', 'slow,full', 'fast,empty', 'fast,full'),
                           ordered = TRUE))
```
...
# Best model performance by Test set
